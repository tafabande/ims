...
def trigger_reconciliation_scan(
    scan_data: ReconciliationScanRequest | None = None,
    ...
    reconciliation_service.run_inventory_reconciliation_scan(db, store_id, wh_id)
    reconciliation_service.detect_sales_inventory_anomalies(db)
...
def resolve_inventory_exception(
    ...
    return reconciliation_service.resolve_exception(
        db, exception_id, resolve_data.resolution_type, resolve_data.investigation_notes
    )
            ...
            "custody_movements": [
                {
                    ...
                    "location": "Harare Main WH (WH-001) - Bin A-12",
                    "action": "INITIAL_RECEIVING",
                    "qty": 98,
                    "actor": "EMP-00031",
                },
                {
                    "timestamp": "2026-08-22T10:15:00Z",
                    "location": "Harare Main WH -> Bulawayo Hub",
                ...
                },
                {
                    ...
                    "location": "Harare Main WH",
                    "action": "CUSTOMER_SALES",
                    "qty": 63,
                    "actor": "EMP-00014",
                },
                {
