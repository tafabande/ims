...
from app.schemas import (
    ...
    POPSubmitRequest, POPVerificationResponse, POPReviewRequest
)
...
@router.post("/submit-pop", response_model=POPVerificationResponse, status_code=status.HTTP_201_CREATED)
...
def reject_proof_of_payment(
    ...
    """
    verifier_id = 2
    return payment_service.reject_pop(db, pop_id, verifier_id, data.rejection_reason or "Invalid transaction reference")
